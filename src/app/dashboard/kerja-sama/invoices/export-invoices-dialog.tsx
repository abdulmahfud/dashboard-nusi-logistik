...
interface Props {
  ...
  /** Status awal mengikuti filter halaman; nilai selain kode status invoice dianggap "all". */
...
/** Export Invoice Kerja Sama (docs/be-fe/export-invoice-kerjasama.md). Tanggal = tanggal invoice dibuat. */
export default function ExportInvoicesDialog({
  open,
  onOpenChange,
  initialStatus = "all",
}: Props) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="rounded-2xl border-slate-100 sm:max-w-md">
        <DialogHeader>
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              <DialogTitle>Export Invoice Kerja Sama</DialogTitle>
              <DialogDescription>
                Pilih status dan rentang tanggal invoice dibuat. Kosongkan untuk
                semua invoice.
              </DialogDescription>
            </div>
          </div>
        ...
        <div className="flex items-start gap-2 rounded-lg border border-amber-200 bg-amber-50 p-3 text-xs text-amber-800">
          ...
          <p>
            File berisi data penagihan pengguna. Jangan dibagikan tanpa
